	...
	articles.getAll().done(function(){
		...
		for(var i = 0; i<articles.models.length; i++) {
			...
			if (articles.models[i].main_image_url) {
				...
				var horizontalSeparator = $("<div class='horizontalSeparator' id='comments_separator_"+articles.models[i].id+"'></div>");
				...
				var commentsBtn = $("<input type='button' class='box2' data-value='"+articles.models[i].id+"' onclick='goToArticlePage("+articles.models[i].id+")' name='button' value='View' id='view_"+articles.models[i].id+"'?/>");
				...
				var noImgContentDiv = $("<div class='contentDiv2' id='content_"+articles.models[i].id+"'></div>");
				...
				var noImgHorizontalSeparator = $("<div class='horizontalSeparator' id='comments_separator_"+articles.models[i].id+"'></div>");
				...
				var noImgCommentsBtn = $("<input type='button' data-value='"+articles.models[i].id+"' onclick='goToArticlePage("+articles.models[i].id+")' class='box2' name='button' value='View' id='view_"+articles.models[i].id+"'?/>");
...
function goToArticlePage(currentArticleId) {
	...
	window.location.href = "https://web9-farki92.c9users.io/blog/UI/pages/article.html?id="+currentArticleId;
}
